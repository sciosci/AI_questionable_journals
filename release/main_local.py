...
feature_dir = './labeled_feature_data_local_html/'
html_dir = './labeled_data_middle_result_final/'
...
for s in range(0,step):
    ...
    get_content_feature_local(urls,'web_content_features_1_'+str(s),12,feature_dir,html_dir)
    print('half way')
    get_content_feature_local(urls2,'web_content_features_0_'+str(s),12,feature_dir,html_dir)
    print('getting tag feature')
    get_tag_feature_local(urls,'web_html_tag_features_1_'+str(s),feature_dir,html_dir,12)
    print('half way')
    get_tag_feature_local(urls2,'web_html_tag_features_0_'+str(s),feature_dir,html_dir,12)
    print('getting font feature')
    get_font_feature_local(urls,'web_font_features_1_'+str(s),feature_dir,html_dir,12)
    print('half way')
    get_font_feature_local(urls2,'web_font_features_0_'+str(s),feature_dir,html_dir,12)
