...
all_urls = list(tmp['URL'])

tmp2 = df[df['Reason'] == 'Still in DOAJ index']
all_urls2 = list(tmp2['URL'])

random.shuffle(all_urls)
random.shuffle(all_urls2)
...
#urls = ['https://opticaapplicata.pwr.edu.pl/']
#urls = ['https://www.acadsci.fi/mathematica/']
urls = ['https://aoemj.biomedcentral.com/']

get_tag_feature(urls,'web_html_tag_features_1_remove2','/home/hzhuang/Projects/Predatory_Journal/release/null/')
#get_font_feature(urls,'web_font_features_1_remove1','/home/hzhuang/Projects/Predatory_Journal/release/null/')

#get_content_feature(urls,'web_content_features_1_test',2,'/home/hzhuang/Projects/Predatory_Journal/release/null/','/home/hzhuang/Projects/Predatory_Journal/release/null/',chrome_path)

exit()


urls = ['https://journals.indexcopernicus.com/journal/9459']

#get_font_feature(urls,'web_font_features_1_remove2','/home/hzhuang/Projects/Predatory_Journal/release/null/')
#get_tag_feature(urls,'web_html_tag_features_1_remove2','/home/hzhuang/Projects/Predatory_Journal/release/null/')
get_content_feature(urls,'web_content_features_1_test2',2,'/home/hzhuang/Projects/Predatory_Journal/release/null/','/home/hzhuang/Projects/Predatory_Journal/release/null',chrome_path)
...
for s in range(0,step):
    ...
    get_content_feature(urls,'web_content_features_1_'+str(s),12,feature_dir,saving_dir,chrome_path)
    print('half way')
    get_content_feature(urls2,'web_content_features_0_'+str(s),12,feature_dir,saving_dir,chrome_path)
    print('getting tag feature')
    get_tag_feature(urls,'web_html_tag_features_1_'+str(s),feature_dir)
    print('half way')
    get_tag_feature(urls2,'web_html_tag_features_0_'+str(s),feature_dir)
    print('getting font feature')
    get_font_feature(urls,'web_font_features_1_'+str(s),feature_dir)
    print('half way')
    get_font_feature(urls2,'web_font_features_0_'+str(s),feature_dir)
    ...
    get_color_feature(unwhite_directory,'web_color_features_1_'+str(s),feature_dir)
    print('half way')
    get_color_feature(white_directory,'web_color_features_0_'+str(s),feature_dir)
